...
const App = () => {
  return (
    <div className='bg-black w-full h-full px-10 py-10 '>
      <div className='w-50 bg-white rounded-3xl h-75 pt-0.5 relative'>
        
        <div className='w-[98%] h-[34%] rounded-3xl bg-red-600 m-auto'>
        ...
        <div className='rounded-full h-17 w-17 bg-red-300 border-2 border-white absolute top-[23%] left-[50%] translate-x-[-50%]'>
      ...
      <div className='flex gap-3 ml-0.5 mt-4 text-center bg-gray-50 rounded-2xl'>
          <div >
